            ...
            <sec:authorize access="!isAuthenticated()">
               <c:choose>
                  <c:when test="${list.lgrade > 0 }">
                     <li class="nav-item"><a href="javascript:void(0)" onClick="alert('회원제입니다. 로그인해 주세요.');">${list.bbstitle }</a></li>
                  </c:when>
                  <c:otherwise>
     ...
     <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="mt-3">
                   <form class="d-flex py-2 px-3 flex-wrap">
                      ...
                      <div class="col-12 text-center mb-3">
                         <button type="button" class="btn btn-primary" onclick="sendMessage();">메시지보내기</button>
                      </div> 
                   </form>
                   
                   <div class="mt-4">
                      <h6>보낸 메시지 목록</h6>
                      <ul class="list-group" id="sent-message-list"></ul>
                   </div>
                   
                   <!-- 받은 메시지 목록 -->
                   <div class="mt-4">
                      <h6>받은 메시지 목록</h6>
                      <ul class="list-group" id="message-list"></ul>
                   </div>
                </div>  
